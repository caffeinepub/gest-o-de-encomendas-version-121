...
import { Plus, X, Loader2, FileImage, Search, ChevronDown, ChevronUp } from 'lucide-react';
...
export default function EditOrcamentoDialog({ open, onOpenChange, orcamento }: EditOrcamentoDialogProps) {
